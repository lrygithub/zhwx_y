...
(function (RegUtils) {
    ...
    */
    ...
    RegUtils.isRealName = isRealName;
    function checkIsChinese(s) {
        var re = /^[\u4E00-\u9FA5]/;
        return (re.test(s));
    }
    RegUtils.checkIsChinese = checkIsChinese;
    /*
    ...
    */
    ...
    /**
      * 判断是否满足a-z
      */
    function isAccountaz(str) {
        var regu = /^[a-z]+$/;
        return regu.test(str);
    }
    RegUtils.isAccountaz = isAccountaz;
    /**
       * 判断是否满足0-9
       */
    function isAccount09(str) {
        var regu = /^[0-9]+$/;
        return regu.test(str);
    }
    RegUtils.isAccount09 = isAccount09;
    /**
         * 判断是否为1位小数或整数或为空
         */
    ...
    RegUtils.isOneNumber = isOneNumber;
})(RegUtils || (RegUtils = {}));
// 1 数字：^[0-9]*$ 
// 2 n位的数字：^\d{n}$
// 3 至少n位的数字：^\d{n,}$ 
